			...
			<div class="login_cont">
				<form action="doLogin.php" method="post">
					<ul class="login">
						...
						<li class="mb_10"><input type="text" name="username" class="login_input user_icon" placeholder="邮箱/用户名/手机号"></li>
						<li class="l_tit">密码</li>
						<li class="mb_10"><input type="password" name="password" class="login_input" placeholder="密码"></li>
						<li class="l_tit">验证码</li>
						<li class="mb_10"><input type="text" name="verify" class="login_input " placeholder="验证码"></li>
						...
						<li><button type="submit" class="login_btn">登录</button></li>
					</ul>
				</form>		
			</div>
			<!-- <a class="reg_link" href="#">免费注册&gt;&gt;</a> -->
		</div>
	</section>
